      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-3xl">
          <h2 className="text-3xl font-bold sm:text-4xl mb-6 flex items-center">
            <ShieldCheck className="w-8 h-8 mr-4 text-teal-400" />
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-2xl">
            <h3 className="text-xl font-bold mb-6 flex items-center">
              <Key className="w-5 h-5 mr-3 text-teal-400" />
              Permissions Explained
            </h3>
            <div className="space-y-4 text-sm">
              <div className="pb-4 border-b border-white/10">
                <span className="font-bold text-teal-400">Read & Change data:</span>
              ...
              <div className="pb-4">
                <span className="font-bold text-teal-400">Context Menus:</span>
            ...
            <a
              ...
              className="mt-8 w-full inline-flex justify-center py-3 px-4 bg-white text-slate-900 font-bold rounded-lg hover:bg-teal-400 transition-colors"
            >
