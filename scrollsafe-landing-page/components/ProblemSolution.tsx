      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 bg-slate-50 p-8 rounded-2xl border border-slate-100">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-teal-50 text-teal-600 text-xs font-bold uppercase tracking-wider">
              The Solution
            </div>
            <h2 className="text-3xl font-bold text-slate-900 leading-tight">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-start text-slate-600">
                  <CheckCircle2 className="w-5 h-5 text-teal-500 mr-3 mt-1 shrink-0" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
